...
/****** Object:  View [dbo].[DRIVER_RATINGS]    Script Date: 11/20/2014 11:54:22 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT     SUM(dbo.GetDrLastHoursRateOrdCount(dbo.Voditelj.BOLD_ID, 12, dbo.ORDER_TARIF.RATING_SUMM) * (1 + 0.5 * dbo.ORDER_TARIF.RATING_PRIORITY)) AS DRIVER_RATING, 
                      dbo.Voditelj.Pozyvnoi
FROM         dbo.ORDER_TARIF CROSS JOIN
                      dbo.Voditelj
WHERE     (dbo.ORDER_TARIF.IN_RATING = 1)
GROUP BY dbo.Voditelj.Pozyvnoi
